...
def run_gao(pop_size, n_sp, locs, widths, n_gen, mutation_rate, fitness_func, nprocs):
    ...
    for i_gen in tqdm(range(n_gen), desc="Generations: "):
        ...
        # Mutation
        if i_gen < (n_gen - 1):
            chromosomes = Main.mutation(
                chromosomes, locs, widths, pop_size, n_sp, mutation_rate
            )
